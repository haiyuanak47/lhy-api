                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <button class="btn btn-default btn-xs" type="button" onclick="javascript:window.location.href='${request.contextPath}/document/detailApi?id=${document.id}'" >MarkDown</button>
                        </div>
                    </div>
                                        ...
                                        <#if projectGlobalQueryParams?exists>
                                            <#list projectGlobalQueryParams as item>
                                                <#if item.name == key>
                                                    <td>${item.desc}</td>
                                                    <td>${item.type}</td>
                                                    <td><#if item.notNull == "true" >必填<#else>非必填</#if></td>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body " >
                            ...
                            <p>
                                ...
                                <a href="${request.contextPath}/datatype/dataTypeDetail?dataTypeId=${responseDatatype.id}" target="_self">>>>接口详情</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                       <#-- <a href="${request.contextPath}/mock/run/${mock.uuid}" target="_blank" >运行</a>-->
                                        <a href="${request.contextPath}/mock/run/${mock.uuid}" target="_self" >运行</a>
                                        &nbsp;
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <button class="btn btn-info btn-xs" type="button" onclick="javascript:window.location.href='${request.contextPath}/test?documentId=${document.id}';" >+ 接口测试</button>
                        </div>
                    </div>
                    <div class="box-body no-padding" >
                        <table class="table table-striped">
                            ...
                            <#list testHistoryList as testInfo>
                                <tr>
                                    ...
                                    <td>${testInfo.updateTime?datetime}</td>
                                    <td>${testInfo.remark!""}</td>
                                    <td>
                                        <#--<a href="${request.contextPath}/test?documentId=${document.id}&testId=${testInfo.id}" target="_blank" >运行</a>-->
                                        <#--<a href="${request.contextPath}/test?documentId=${document.id}&testId=${testInfo.id}" target="_self" >运行</a>-->
                                        <button class="btn btn-info btn-xs" type="button" onclick="javascript:window.location.href='${request.contextPath}/test?documentId=${document.id}&testId=${testInfo.id}';">运行</button>
