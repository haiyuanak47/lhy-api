                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-header with-border">
                            ...
                            <#if hasBizPermission>
                                ...
                                <button class="btn btn-info btn-xs" type="button" onclick="javascript:window.open('${request.contextPath}/globalparam/updatePage?projectId=${projectId}')" >全局参数</button>
                            </#if>
