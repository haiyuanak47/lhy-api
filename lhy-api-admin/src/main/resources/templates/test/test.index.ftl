            ...
            <form class="form-horizontal" id="ducomentForm" >
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">基础信息 - ${document.name}</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-1 control-label">Test备注</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="remark" placeholder="请输入Test备注" maxlength="100"
                                       <#if testHistory?exists && testHistory.remark?exists >value="${testHistory.remark}"</#if> >
                            </div>
                        </div>
                        ...
                        <#if queryParams?exists>
                            <#list queryParams as item>
                                <div class="form-group queryParams_item" >
                                    ...
                                    <label class="col-sm-1 control-label">值</label>
                                    <div class="col-sm-5 item">
                                        <input type="text" class="form-control value" value="<#if testId gt 0>${item.value?replace('"', '&quot;')}<#else></#if>" >
                                    </div>
                                    <button type="button" class="col-sm-1 btn btn-box-tool delete" ><i class="fa fa-fw fa-close"></i></button>
                                </div>
                            </#list>
                        ...
                        <#if globalQueryParams?exists>
                            <#list globalQueryParams as item>
                                ...
                                <div class="form-group globalQueryParams_item" >
                                    ...
                                    <label class="col-sm-1 control-label">Value</label>
                                    <div class="col-sm-5 item">
                                        <input type="text" class="form-control value" value="${value?replace('"', '&quot;')}" readonly>
                                    </div>
                                    <button type="button" class="col-sm-1 btn btn-box-tool delete" ><i class="fa fa-fw fa-close"></i></button>
                                </div>
                            </#list>
